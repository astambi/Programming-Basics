...
namespace _01_Cake_Tycoon
{
    class Program
    {
        ...
        {
            int cakesPlanned = int.Parse(Console.ReadLine());       //n
            double flourPerCake = double.Parse(Console.ReadLine()); //c kg
            int flourAvailable = int.Parse(Console.ReadLine());     //f, kg, cost of flour = 0
            int numTruffles = int.Parse(Console.ReadLine());        // t
            int priceTruffle = int.Parse(Console.ReadLine());       //p
