...
namespace _04_Spiral_Matrix
{
    class _04_Spiral_Matrix
    {
        static void Main(string[] args)
        {
            ...
            char[,] matrix = GetSpiralMatrix(n, text);
            int maxWeightRow = GetMaxWeightRow(matrix);
            int maxWeight = GetRowWeight(matrix, maxWeightRow);

            Console.WriteLine("{0} - {1}", maxWeightRow, maxWeight);
        }

        static int GetMaxWeightRow (char[,] matrix)
        {
            int maxWeight = 0;
            int maxWeightRow = 0;
        ...
        static char[,] GetSpiralMatrix(int n, string text)
        {
